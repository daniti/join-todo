...
class Todo extends Model {
   ...
   public static function allTodos() {
      return static::orderBy('vieworder', 'desc')->orderBy('created_at', 'desc')->orderBy('id', 'desc')->get();
   }

   public static function findTodos($ids) {
      return static::whereIn('id', $ids)->orderBy('vieworder', 'desc')->orderBy('created_at', 'desc')->orderBy('id', 'desc')->get();
   }
